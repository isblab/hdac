...
threshold = {
        'SIN3A_PAH3': 0.031,                # 10%
        'SIN3A_HID': 0.0435,                # 10%
        'SAP30_N-term': 0.0308,             # 28%
        'SAP30_ZFD': 0.0363,                # 10%
        'SAP30_SID': 0.03975,               # 15%
        'SUDS3_N-term': 0.004172,           # 28%
        'SUDS3_dimerization': 0.0096,       # 15%
        'SUDS3_SID': 0.0132,                # 10%
        'SUDS3_C-term': 0.006825,           # 15%
        'HDAC1_1-376': 0.10905,             # 15%
        'HDAC1_C-term_377-482': 0.0462  }   # 28%
