...
threshold = {
        'RCOR1_Nterm': 0.0159,            # 10%
        'RCOR1_ELM-SANT1': 0.0411,        # 10%
        'RCOR1_240-310': 0.08,            # 10%
        'RCOR1_LINKER': 0.043,            # 10%
        'RCOR1_SANT2': 0.0513,            # 10%
        'RCOR1_Cterm': 0.0475,            # 10%
        'KDM1A_1-170': 0.0709,            # 10%
        'KDM1A_SWIRM': 0.0741,            # 10%
        'KDM1A_AOD1': 0.0589,             # 10%
        'KDM1A_TOWER': 0.0579,            # 10%
        'KDM1A_AOD2': 0.077,              # 10%
        'KDM1A_Cterm': 0.0196,            # 10%
        'HDAC1_1-376': 0.0791,            # 10%
        'HDAC1_C-term_377-482': 0.0223  } # 10%
