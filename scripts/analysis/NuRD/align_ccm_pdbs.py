...
pdb_files = ['offset_corrected/offset_added_HDAC1-MTA1_ext.pdb',\
            'offset_corrected/MTA1.0_1-164_BAH.pdb',\
            'offset_corrected/MTA1.0_334-353_ns.pdb',\
            'offset_corrected/MTA1.0_389-431_ZF.pdb',\
            'offset_corrected/MTA1_AF.pdb',\
            'offset_corrected/MTA1.1_1-164_BAH.pdb',\
            'offset_corrected/MTA1.1_334-353_ns.pdb',\
            'offset_corrected/MTA1.1_389-431_ZF.pdb',\
            'offset_corrected/MTA1_AF.pdb',\
            'offset_corrected/RBBP4.0-MTA1_468-546_5FXY.pdb',\
            'offset_corrected/RBBP4.1-MTA1_468-546_5FXY.pdb',\
            'offset_corrected/RBBP4.2-MTA1_670-691_4PBZ.pdb',\
            'offset_corrected/RBBP4.3-MTA1_670-691_4PBZ.pdb',\
            'offset_corrected/MBD3.0_1-71.pdb',\
            'offset_corrected/MBD3_AF.pdb',\
            'offset_corrected/GATAD2B_AF.pdb',\
            'offset_corrected/offset_added_GATAD2B-Anumbers-MBD3-cc.pdb'] #,\
...
all_proteins = [{'MTA1':{'A':[0,range(165,334)]},'MTA1':{'C':[1,range(165,334)]}, 'HDAC1':{'B':[0,range(8,377)]},'HDAC1':{'D':[1,range(8,377)]}},\
            ...
            {'MBD3':{'A':[0,range(1,72)]}},\
            {'MBD3':{'A':[0,range(172,214)]}},\
            {'GATAD2B':{'A':[0,range(26,53)]}},\
            {'MBD3':{'B':[0,range(221,250)]},'GATAD2B':{'A':[0,range(137,179)]}}] #,\
            # {'MBD3':{'A':[1,range(1,72)]}},\
