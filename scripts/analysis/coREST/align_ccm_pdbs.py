...
pdb_files = ['offset_corrected/offset_added_RCOR1-HDAC1.pdb',\
            # 'offset_corrected/KDM1A_2com.pdb',\
            'offset_corrected/2V1D.pdb'] #,\
...
all_proteins = [{'RCOR1':{'A':[0,range(1,137)]},'HDAC1':{'B':[0,range(8,376)]}},\
            # {'KDM1A':{'A':[0,range(1,124)]}},\
            {'KDM1A':{'A':[0,range(171,836)]}, 'RCOR1':{'B':[0,range(3011,440)]}}]
