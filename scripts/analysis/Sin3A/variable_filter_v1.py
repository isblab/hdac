...
def variable_filter(std_multiplier,df):
    if args.evr == False:
        ...
        selected_df = df[(df['XLs_sum'] <= common_df_mean['XLs_sum'] + std_multiplier*common_df_std['XLs_sum'])]
        #   &  (df['MinimumPairDistanceBindingRestraint'] <= common_df_mean['MinimumPairDistanceBindingRestraint'] + std_multiplier*common_df_std['MinimumPairDistanceBindingRestraint'])
    else:
        ...
        selected_df = df[(df['XLs_sum'] <= common_df_mean['XLs_sum'] + std_multiplier*common_df_std['XLs_sum'])  &  (df['MinimumPairDistanceBindingRestraint'] <= common_df_mean['MinimumPairDistanceBindingRestraint'] + std_multiplier*common_df_std['MinimumPairDistanceBindingRestraint'])   &   (df['EV_sum'] <= common_df_mean['EV_sum'])]
